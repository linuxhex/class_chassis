...
git_repository(
    name = "ros_common_git",
    remote = "http://gitlab.wisagv.com/ros_common/ros_common.git",
...
git_repository(
    name = "ros_base_git",
    remote = "http://gitlab.wisagv.com/ros_common/ros_base.git",
    init_submodules = True,
...
git_repository(
    name = "boost_git",
    remote = "http://gitlab.wisagv.com/common/boost_lib.git",
...
git_repository(
    name = "glog_git",
    remote = "http://gitlab.wisagv.com/common/glog.git",
    init_submodules = True,
...
git_repository(
    name = "python_git",
    remote = "http://gitlab.wisagv.com/common/python_lib.git",
